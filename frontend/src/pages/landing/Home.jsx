...
function Home() {
  ...
  const courses = [
    { id: 1, title: "JavaScript Beginner Course", img: c1, price: 1499 },
    { id: 2, title: "HTML Complete Course", img: c2, price: 1499 },
    { id: 3, title: "SQL Beginner Course", img: c3, price: 1499 },
    { id: 4, title: "Python Master Course", img: c4, price: 1499 },
    { id: 5, title: "Java Essentials", img: c5, price: 1499 },
    { id: 6, title: "CSS Complete Course", img: c6, price: 1499 },
  ];
      ...
      <section className="relative px-6 py-24 flex flex-col items-center justify-center text-center bg-secondary/20">
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-8 leading-tight">
            Register Now &amp; Unlock Your Learning Potential
          </h1>
